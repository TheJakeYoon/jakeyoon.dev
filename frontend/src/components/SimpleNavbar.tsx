        ...
        <StyledToolbar variant="dense" disableGutters>
          <Box sx={{ flexGrow: 1, display: 'flex', alignItems: 'center', px: 0 }}>
            ...
            <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
              <Button variant="text" color="info" size="small" onClick={() => scrollToSection('home')}>
                Home
              </Button>
              <Button variant="text" color="info" size="small" onClick={() => scrollToSection('about')}>
                About
              </Button>
              <Button variant="text" color="info" size="small" onClick={() => scrollToSection('projects')}>
                Projects
              </Button>
              <Button variant="text" color="info" size="small" onClick={() => scrollToSection('resume')}>
                Resume
              </Button>
            </Box>
          </Box>
          ...
          <Box sx={{ display: { xs: 'flex', md: 'none' }, gap: 1 }}>
            ...
            >
              <Box sx={{ p: 2, backgroundColor: 'background.default' }}>
                ...
                <MenuItem onClick={() => scrollToSection('resume')}>Resume</MenuItem>
                <Divider sx={{ my: 3 }} />
                <MenuItem>
                  <Button color="primary" variant="contained" fullWidth onClick={() => scrollToSection('contact')}>
                    Contact
                  </Button>
                </MenuItem>
              </Box>
